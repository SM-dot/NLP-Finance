...
body { font-family: -apple-system, "Helvetica Neue", Arial, sans-serif; font-size: 9.5pt;
       line-height: 1.42; color: #1a1a1a; max-width: 100%; }
h1 { font-size: 17pt; margin-bottom: 4px; }
h2 { font-size: 12.5pt; margin-top: 20px; border-bottom: 1.5px solid #ccc; padding-bottom: 3px; }
h3 { font-size: 10.5pt; margin-top: 14px; }
p { margin: 6px 0; }
ul, ol { margin: 5px 0 8px 0; }
li { margin: 2px 0; }
table { border-collapse: collapse; width: 100%; margin: 8px 0 14px 0; font-size: 8pt; }
th, td { border: 1px solid #bbb; padding: 3px 6px; text-align: left; }
th { background: #f0f0f0; }
img { max-width: 100%; margin: 8px 0; }
code { background: #f2f2f2; padding: 1px 4px; border-radius: 3px; font-size: 8.5pt; }
strong { color: #111; }
hr { border: none; border-top: 1px solid #ccc; margin: 14px 0 8px 0; }
em { color: #333; }
"""
